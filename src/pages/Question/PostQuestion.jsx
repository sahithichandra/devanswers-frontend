...
import { Col, Container, Form, Button, Card, Row, Alert, Spinner } from 'react-bootstrap';
                ...
                <Form onSubmit={handleSubmit}>
                  <Form.Group className="mb-4">
                    ...
                    {suggestions?.title && (
                      <Alert variant="info" className="mt-2 mb-0 p-2">
                        <div className="mb-2"><strong>Suggested:</strong> {suggestions.title}</div>
                        <Button size="sm" variant="success" className="me-2" onClick={() => acceptSuggestion('title')}>Accept</Button>
                        <Button size="sm" variant="outline-secondary" onClick={() => rejectSuggestion('title')}>Reject</Button>
                      </Alert>
                    )}
                  </Form.Group>
                  ...
                  <Form.Group className="mb-4">
                    ...
                    {suggestions?.description && (
                      <Alert variant="info" className="mt-2 mb-0 p-2">
                        <div className="mb-2"><strong>Suggested:</strong> {suggestions.description}</div>
                        <Button size="sm" variant="success" className="me-2" onClick={() => acceptSuggestion('description')}>Accept</Button>
                        <Button size="sm" variant="outline-secondary" onClick={() => rejectSuggestion('description')}>Reject</Button>
                      </Alert>
                    )}
                  </Form.Group>
                  ...
                  <Form.Group className="mb-4">
                    ...
                    {suggestions?.tags && (
                      <Alert variant="info" className="mt-2 mb-0 p-2">
                        <div className="mb-2"><strong>Suggested:</strong> {suggestions.tags}</div>
                        <Button size="sm" variant="success" className="me-2" onClick={() => acceptSuggestion('tags')}>Accept</Button>
                        <Button size="sm" variant="outline-secondary" onClick={() => rejectSuggestion('tags')}>Reject</Button>
                      </Alert>
                    )}
                  </Form.Group>
                  ...
                  {userInfo && (
                    ...
                    >
                      {isImproving ? (
                        <><Spinner as="span" size="sm" className="me-2" />Improving...</>
                      ) : (

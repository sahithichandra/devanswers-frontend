...
describe("PostQuestion Page", () => {
  ...
  it("renders the title input", () => {
    renderPostQuestion();
    expect(
      screen.getByPlaceholderText(/what's your programming question/i),
    ).toBeInTheDocument();
  });
  ...
  it("renders the description textarea", () => {
    renderPostQuestion();
    expect(
      screen.getByPlaceholderText(/provide more details about your question/i),
    ).toBeInTheDocument();
  });
  ...
  it("renders the tags input and submit button", () => {
    renderPostQuestion();
    expect(
      screen.getByPlaceholderText(/e.g., javascript, react, css/i),
    ).toBeInTheDocument();
    expect(
  ...
  it("allows typing in the title field", async () => {
    ...
    const titleInput = screen.getByPlaceholderText(
      /what's your programming question/i,
    );
  ...
  it("allows typing in the description field", async () => {
    ...
    const descriptionInput = screen.getByPlaceholderText(
      /provide more details about your question/i,
    );

    await userEvent.type(
      descriptionInput,
      "I want to manage state effectively.",
    );
